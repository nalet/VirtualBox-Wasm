...
/*#undef GETXATTR_WITH_POSIX_ACLS 1 */
...
#if _MSC_VER_ >= 1700 /* 2012 and later */
...
#define _REGEX_LARGE_OFFSETS 1 /* shuts up a whole bunch of warnings w/o creating too many new ones */
...
#define restrict /* A bit problematic as this messes up __declspec(restrict). */
...
#if defined(KBUILD_ARCH_AMD64) || defined(KBUILD_ARCH_ARM64)
...
/*   #undef static_assert */
 ...
 #endif
# ifdef _MSC_VER
#  define static_assert(expr) typedef int MY_STATIC_ASSERT_TYPE[(expr) ? 1 : 0]
# endif
#endif
...
extern int   rpl_mkdir(char const *, mode_t);
#define mkdir(a,b) rpl_mkdir(a,b)
