          ...
          if (hltCnt >= 3e4 && hltCS === 61440 && ip === 28828 && !execBlock._directBootDone) {
            ...
            if (mem8[md + 12] === 75 && mem8[md + 13] === 82 && mem8[md + 14] === 78 && mem8[md + 15] === 76) {
              ...
              if (hdrSig === "HdrS" && highRamPtr) {
                ...
                console.log("[DIRECT-BOOT] Kernel loaded! CS=" + ENTRY_SEG.toString(16) + ":0000 initrd@0x" + INITRD_GPA.toString(16) + " (" + (initrdLen >> 10) + "KB)");
                console.log("[DIRECT-BOOT] VERIFY: CS.sel=0x" + verCS.toString(16) + " CS.base=0x" + verCSBase.toString(16) + " RIP=0x" + verIP.toString(16) + " RSP=0x" + verSP.toString(16) + " FL=0x" + verFL.toString(16) + " CR2=0x" + verCR2.toString(16) + " cpuPtr=0x" + cpuPtr.toString(16) + " S_CS=0x" + S_CS.toString(16));
                ...
                {
                  const rb = ramBase;
                  dv.setUint16(rb + 28720, verCS, true);
                  // verified CS
                  dv.setUint32(rb + 28722, verCSBase, true);
                  // verified CS base
                  dv.setUint32(rb + 28726, verIP & 4294967295, true);
                  // verified RIP
                  dv.setUint32(rb + 28730, verSP & 4294967295, true);
                  // verified RSP
                  dv.setUint32(rb + 28734, verFL, true);
                  // verified FLAGS
                  dv.setUint32(rb + 28738, verCR2, true);
                  // verified CR2
                  mem8[rb + 28742] = 219;
                }
